            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="do" class="col-md-4 col-form-label text-md-right">{{ __('Date of Birth') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="annual_income" type="text" class="form-control @error('annual_income') is-invalid @enderror" name="annual_income" value="{{ old('annual_income') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="occupation" class="form-control" name="occupation" required multiple>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="family_type" class="form-control" name="family_type" required multiple>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="manglik" class="form-control" name="manglik" required>
